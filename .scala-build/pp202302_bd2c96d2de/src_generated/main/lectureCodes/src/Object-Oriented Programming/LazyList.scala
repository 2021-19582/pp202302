...
final class LazyList$_ {
def args = LazyList_sc.args$
def scriptPath = """lectureCodes/src/Object-Oriented Programming/LazyList.sc"""
/*<script>*/
//
...
object LazyList_sc {
  ...
  lazy val script = new LazyList$_
...
export LazyList_sc.script as LazyList
