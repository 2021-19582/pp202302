...
final class Classes$_ {
def args = Classes_sc.args$
def scriptPath = """lectureCodes/src/Object-Oriented Programming/Classes.sc"""
/*<script>*/
...
export Classes_sc.script as Classes
