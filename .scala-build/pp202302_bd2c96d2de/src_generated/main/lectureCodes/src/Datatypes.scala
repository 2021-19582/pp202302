...
final class Datatypes$_ {
def args = Datatypes_sc.args$
def scriptPath = """lectureCodes/src/Datatypes.sc"""
/*<script>*/
...
object Datatypes_sc {
  ...
  lazy val script = new Datatypes$_
...
export Datatypes_sc.script as Datatypes
